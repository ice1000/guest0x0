...
\newcommand{\SubTy}[3]{\textsf{Sub}~{#1}~\LRbbar{\begin{array}{#2}#3\end{array}}}
\newcommand{\subTy}[2]{\textsf{Sub}~{#1}~\lrbbar{#2}}
\newcommand{\inS}[1]{\textsf{inS}(#1)}
\newcommand{\outS}[1]{\textsf{outS}(#1)}
