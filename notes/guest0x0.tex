...
However, there isn't any easy workarounds.
See the ICMS talk \url{https://cse.umn.edu/cs/feature-stories/nullable-compositions-talk}}.
...
Note that $\disj$ in this case is $(z\equiv\rcon)$,
and the corresponding terms should look like the following,
where \fbox{$x:\II;z\equiv \rcon \vdash u:A$}:
\[
	\lam x \lrbbar{z\equiv\rcon \mapsto u} :
	\II \to \Partial{z\equiv\rcon} A
\]
Then, \hcompLong{} should give us the following,
where $u[\rcon/x]$ is just the top face of the wall $u$:
\[
\hcomp{A}{\lam x \lrbbar{z\equiv\rcon \mapsto u}}
: \subTy{A}{z\equiv\rcon}{z\equiv\rcon \mapsto u[\rcon/x]}
\]
\carloCTikZ{
\carloXyz
\refcube{URconX}
...
\[
	...
	\to \subTy{A}{\phi(x)}{z\equiv\rcon \mapsto u}
\]
