...
and the De Morgan operators on $\II$, including:
\begin{align*}
	\neg & \text{involution/reversal} & \land & \text{minimum/squeezeLeft}\\
	 &  & \lor & \text{maximum/squeezeRight}
\end{align*}
where $\land$ and $\lor$ are also together known as ``connections''.
\end{itemize}
...
\inferrule{\PGvdash u:\II}{\PGvdash u\land 0\equiv 0:\II}\and
\inferrule{\PGvdash u:\II}{\PGvdash u\land 1\equiv u:\II}\and
\inferrule{\PGvdash u:\II \\\\ \PGvdash v:\II}{\PGvdash u\lor v:\II}\and
\inferrule{\PGvdash u:\II}{\PGvdash u\lor 0\equiv u:\II}\and
\inferrule{\PGvdash u:\II}{\PGvdash u\lor 1\equiv 1:\II}
\end{mathpar}
...
\newcommand{\minmaxPoints}[1]{
\node (00) at (0, 0) {a};
\node (11) at (1.2, 1.2) {b};
\node (10) at (1.2, 0) {#1};
\node (01) at (0, 1.2) {#1};
\fill [fill=black, fill opacity=0.2, draw=white, draw opacity=0, line width=2.5pt]
...
and the rest is very easy to infer, hence left to the readers.
