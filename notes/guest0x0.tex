...
\subsection{Reducing partial elements by substitution on cofibrations}\label{sub:red-cofib}
...
In this case, we say that the face is \textit{satisifed}.
...
$\lrbbar{\overline{\conj_i\mapsto u_i}$ for $i\in I$.
