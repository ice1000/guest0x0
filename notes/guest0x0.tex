...
\begin{mathpar}
\inferrule{\PGvdash\isType A\\ \PGvdash u:A\\ \PGvdash v:A}
{\PGvdash\isTypeBox{\Path A u v}}\and
\inferrule{\Hint{\PGvdash\isTypeBox{\Path A u v}} \\ \Phi,x:\II;\Gvdash u:A}
{\PGvdash \plam x u : \Path A{(u[\lcon/x])}{(u[\rcon/x])}}
\end{mathpar}
\TODO
