...
The implementation is basically a rewrite of~\cite[\S 3]{HCompPDF},
as in~\cref{fig:typing-transp}.

\begin{figure}[h!]
\begin{mathpar}
\inferrule{\PiGvdash{x}\isType A \\
\Psi\vdash\overline{\conj_i} \\ \PiGvdash{x}\isType{A\equiv A[\lcon/x]}}{
...
computation behavior from the typing:

\begin{figure}[h!]
\begin{mathpar}
\inferrule{\PiGvdash{x}\isType A \\
\Psi\vdash\overline{\conj_i} \\ \PiGvdash{x}\isTypeBox{A\equiv A[\lcon/x]}}{
\PGvdash\coe{\lam x A}{\overline{\conj_i}}:A[\lcon/x] \to A[\rcon/x]}\and
