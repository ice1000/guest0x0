...
\and
% Introduction
\inferrule{\Phi\overline{,y_i:\II};\Gamma,\vdash v:A\\\\
\forall j. (\Phi\overline{,y_i:\II};\Gamma,\conj_j\vdash v[\overline{y_i/x_i}]\equiv u_j:A)}
...
The syntax and typing rules are defined in~\cref{fig:subtype,fig:typing-subtype}, respectively.
\begin{figure}[h!]
\[u,A::= \subTy{A}{\overline{\face}}
\mid \outS u \mid \inS u
...
\inferrule{1}{1}
\end{mathpar}
\caption{Syntax of generalized paths}\label{fig:typing-subtype}
\end{figure}
